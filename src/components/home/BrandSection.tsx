      ...
      <div className="relative z-10 px-4 sm:px-6 lg:px-12 max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center lg:items-center gap-12 lg:gap-20">
          ...
          >
            ...
            <div className="flex flex-col gap-6 items-center sm:items-start mt-8 lg:mt-12">
              ...
              <motion.div
                ...
                transition={{ duration: 0.4, delay: 0.2, ease: "easeOut" }}  // Faster
                className="bg-white p-4 shadow-lg text-start rounded-lg w-[160px] sm:w-[180px] lg:w-[216px]"
              ...
              >
                ...
                <div className="font-bold text-[#A8CF45] text-[48px] sm:text-[60px] lg:text-[80px]">
                  200+
                </div>
              </motion.div>
            </div>
            ...
            <div className="flex flex-col gap-6 items-center sm:items-start">
              ...
              <motion.div
                initial={{ scale: 0.3, opacity: 0 }}
                animate={isInView ? { scale: 1, opacity: 1 } : {}}
                transition={{ duration: 0.4, delay: 0.3, ease: "easeOut" }}  // Faster
                className="bg-white p-4 shadow-lg text-start rounded-lg w-[150px] sm:w-[160px] lg:w-[169px]"
                style={{ fontFamily: "Diodrum Cyrillic, sans-serif" }}
              >
                <div className="text-[16px] sm:text-[18px] lg:text-[20px] text-[#3E4095]">
                  Years of
