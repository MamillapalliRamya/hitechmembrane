...
//         {/* Show arrows only if products > 3 */}
//         {products.length > 3 && (
//           <>
//             {/* Left Arrow */}
//             <button
...
//                   <div
//                     className=" bg-[#A8CF45] w-[160px] h-[140px] rounded-bl-[25%] rounded-br-[121%] rounded-tl-[121%] rounded-tr-[25%]
//                                 opacity-20 2xl:w-[301px] 2xl:h-[226px] 2xl:rounded-br-[147%] 2xl:rounded-tl-[147%] 2xl:rotate-[-5deg]"
//                   ></div>
