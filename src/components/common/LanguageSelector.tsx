...
const LanguageSelector: React.FC = () => {
  ...
  const handleLanguageChange = async (languageCode: string) => {
    ...
    try {
      ...
      // Optional: Reload the page to ensure all content is re-translated
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        disabled={isChanging}
        className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
