      ...
      <div className="hidden lg:block">
        <div className="w-full flex justify-center items-center">
          <div className="relative mx-auto" style={{ width: 'min(1440px, 95vw)', height: 'auto', aspectRatio: '1440/600' }}>
            {/* Column 1 */}
            <div style={{ position: 'absolute', left: '10%', top: '10%', width: '13%', height: '16%' }} className="rounded-xl overflow-hidden shadow-md">
              <img src={images.img1} alt="Facility" className="w-full h-full object-cover" />
            </div>
            <div style={{ position: 'absolute', left: '14.5%', top: '30%', width: '9%', height: '20%' }} className="rounded-xl overflow-hidden shadow-md">
              <img src={images.img2} alt="Facility" className="w-full h-full object-cover" />
            </div>
            <div style={{ position: 'absolute', left: '12.5%', top: '54%', width: '14%', height: '20%' }} className="rounded-xl overflow-hidden shadow-md">
              <img src={images.img3} alt="Facility" className="w-full h-full object-cover" />
            </div>

            {/* Column 2 */}
            <div style={{ position: 'absolute', left: '24%', top: '10%', width: '15.5%', height: '30%' }} className="rounded-xl overflow-hidden shadow-md">
              <img src={images.img4} alt="Facility" className="w-full h-full object-cover" />
            </div>
            <div style={{ position: 'absolute', left: '27.5%', top: '44%', width: '14%', height: '20%' }} className="rounded-xl overflow-hidden shadow-md">
              <img src={images.img5} alt="Facility" className="w-full h-full object-cover" />
            </div>
            <div style={{ position: 'absolute', left: '26.5%', top: '68%', width: '14%', height: '14%' }} className="rounded-xl overflow-hidden shadow-md">
              <img src={images.img6} alt="Facility" className="w-full h-full object-cover" />
            </div>

            {/* Column 3 - Center with Logo */}
            <div style={{ position: 'absolute', left: '40.5%', top: '10%', width: '15.5%', height: '14%' }} className="rounded-xl overflow-hidden shadow-md">
              <img src={images.img7} alt="Facility" className="w-full h-full object-cover" />
            </div>
            {/* Logo - No card background */}
            <div style={{ position: 'absolute', left: '42.5%', top: '28%', width: '12%', height: '26%' }} className="flex items-center justify-center">
              <img src={images.logo} alt="Hi-Tech Logo" className="w-full h-full object-contain" />
            </div>
            <div style={{ position: 'absolute', left: '42.5%', top: '58%', width: '11.5%', height: '20%' }} className="rounded-xl overflow-hidden shadow-md">
              <img src={images.img9} alt="Facility" className="w-full h-full object-cover" />
            </div>

            {/* Column 4 */}
            <div style={{ position: 'absolute', left: '56.5%', top: '10%', width: '15.5%', height: '30%' }} className="rounded-xl overflow-hidden shadow-md">
              <img src={images.img9} alt="Facility" className="w-full h-full object-cover" />
            </div>
            <div style={{ position: 'absolute', left: '54.5%', top: '44%', width: '14%', height: '20%' }} className="rounded-xl overflow-hidden shadow-md">
              <img src={images.img10} alt="Facility" className="w-full h-full object-cover" />
            </div>
            <div style={{ position: 'absolute', left: '54.5%', top: '68%', width: '14%', height: '14%' }} className="rounded-xl overflow-hidden shadow-md">
              <img src={images.img11} alt="Facility" className="w-full h-full object-cover" />
            </div>

            {/* Column 5 */}
            <div style={{ position: 'absolute', left: '73.5%', top: '10%', width: '13%', height: '16%' }} className="rounded-xl overflow-hidden shadow-md">
              <img src={images.img12} alt="Facility" className="w-full h-full object-cover" />
            </div>
            <div style={{ position: 'absolute', left: '74.5%', top: '30%', width: '9%', height: '20%' }} className="rounded-xl overflow-hidden shadow-md">
              <img src={images.img13} alt="Facility" className="w-full h-full object-cover" />
            </div>
            <div style={{ position: 'absolute', left: '70%', top: '54%', width: '14%', height: '20%' }} className="rounded-xl overflow-hidden shadow-md">
      ...
      <div className="block lg:hidden px-4">
        <div className="grid grid-cols-3 gap-3 md:gap-4 max-w-[900px] mx-auto">
          ...
          <div className="flex flex-col gap-3 md:gap-4">
            <div className="w-full aspect-[17/9] rounded-lg overflow-hidden shadow-md">
              <img src={images.img1} alt="Facility" className="w-full h-full object-cover" />
            </div>
