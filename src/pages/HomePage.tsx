       ...
       <section className="py-10 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-[20.9px] text-center text-gray-600">
            ...
            <div className="grid md:grid-cols-2 mx-auto">
              <motion.div
                ...
                className="bg-blue-50 pt-4 pr-8 pb-8 pl-8 w-[464px] h-[307px] rounded-[4px] mx-auto flex flex-col"

              >
                {/* <Award  /> */}
                <img src="/assets/images/award1.png" alt="award1" className="w-[198px] h-[196px] text-blue-600 mx-auto"/>
                <h3 className="text-xl font-bold mb-2 mt-2">
                  The Water Digest
                </h3>
                <p className="text-gray-600">Best Membrane (2014-2016)</p>
                <p className="text-sm text-blue-600 mt-3">UNESCO-supported</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.2 }}
                className="bg-blue-50 pt-2 pr-8 pb-8 pl-8 w-[464px] h-[307px] rounded-[4px] mx-auto flex flex-col"
              >
                <img src="/assets/images/award2.png" alt="award2"className="w-[154px] h-[188px] text-blue-600 mx-auto transform scale-90"/>
