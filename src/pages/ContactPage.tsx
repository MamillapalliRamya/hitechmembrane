...
const ContactPage = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <div className="max-w-8xl bg-gray-100 mx-auto px-36 py-28" style={{ paddingBottom: '0px' }}>
        {/* Page Title */}
        <div className="mb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-9">
              ...
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded p-4 text-center bg-gray-50 h-full flex flex-col justify-center" style={{ height: '82%' }}>
                      <Upload className="w-6 h-6 text-gray-400 mx-auto mb-2" />
                      <p className="text-xs text-gray-600 mb-1">Choose a file or drag & drop it here</p>
                      <p className="text-xs text-gray-400 mb-3">JPEG, PNG & PDF files up to 10MB</p>
                      <input
                        type="file"
                ...
                {/* Submit Button */}
                <div className="pt-2 flex justify-center " style={{ marginTop: '30px' }}>
                  <button
                    type="submit"
                    // onClick={handleSubmit}
                    className=" bg-green-500 hover:bg-green-600 text-blue-900 font-medium py-3 px-6 rounded transition-colors"
            ...
            <div className="bg-white rounded-lg shadow-sm border p-5">
              <h3 className="text-center text-blue-700 font-medium mb-10">FOR IMMEDIATE SUPPORT</h3>
              <div className="grid grid-cols-3 gap-6">
                {/* WhatsApp QR */}
                <div className="text-center flex flex-col items-center">
                  <div className="w-12 h-12 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center mx-auto mb-3 transition-colors">
                  ...
                  <div className="w-28 h-28 bg-gray-100 border-2 border-gray-200 rounded mx-auto mb-2 flex items-center justify-center">
                    <img
                      src={image2}
                ...
                {/* WeChat QR */}
                <div className="text-center flex flex-col items-center">
                  <div className="w-12 h-12 bg-green-400 hover:bg-green-500 rounded-full flex items-center justify-center mx-auto mb-3 transition-colors">
                    <svg className="w-7 h-7 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* LINE QR */}
                <div className="text-center flex flex-col items-center">
                  <div className="w-12 h-12 bg-green-600 hover:bg-green-700 rounded-full flex items-center justify-center mx-auto mb-3 transition-colors">
          ...
          <div className="space-y-6">
            {/* Company Header - Integrated with World Map */}
            <div className=" p-6" style={{ paddingBottom: '0px' }}>
              {/* Company Info */}
              <div className="text-center mb-6">
                <h2 className="text-3xl font-bold text-gray-700 mb-3">Hi-Tech Membranes</h2>
                <div className="space-y-2">
                  <a href="mailto:sales@hitechmembranes.com" className="block  text-blue-900 hover:underline text-m">
                    sales@hitechmembranes.com
                  </a>
                  <a href="tel:+91-80-12345678" className="block text-blue-900 hover:underline font-medium">
                    +91-80-12345678
                  </a>
                </div>
              </div>
              ...
              <div className="w-full h-full py-4 flex items-center justify-center relative overflow-hidden">
                ...
                <div className="relative z-10 text-center">
                  <p className="text-gray-500 text-sm mb-2">World Map</p>
                  <p className="text-xs text-gray-400">Replace this div with your map image</p>
                  
                  <div className="absolute top-16 left-20 w-3 h-3 bg-red-500 rounded-full border-2 border-white"></div>
                  <div className="absolute top-20 right-24 w-3 h-3 bg-orange-500 rounded-full border-2 border-white"></div>
                  <div className="absolute bottom-20 left-16 w-3 h-3 bg-green-500 rounded-full border-2 border-white"></div>
                  <div className="absolute top-12 right-16 w-3 h-3 bg-red-600 rounded-full border-2 border-white"></div>
                </div> */}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 gap-6" style={{ marginTop: '0px' }}>
              ...
              <div className="bg-white rounded-lg shadow-sm border p-6">
                ...
                <div className="flex flex-row justify-between">
                  <a href="#" className="block text-blue-900 hover:underline text-md pb-2">
                    FAQs
                  </a>
                  <a href="#" className="block text-blue-900 hover:underline text-md pb-2">
                    Product Brochures
              ...
              <div className="bg-white rounded-lg shadow-sm border p-6">
                ...
                >
                  <div className="flex flex-row justify-between items-center gap-4">
                    <div className="relative w-full h-20" style={{ width: '50%' }}>
                      <img
                        src={image5}
                    ...
                    <p className="text-s text-gray-600 leading-relaxed underline hover:text-blue-900" onClick={handleAddressClick} >
